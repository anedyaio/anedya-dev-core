...
// Feature management
// #define ANEDYA_ENABLE_DEVICE_LOGS - Not supported
...
// ERROR CHECKS - DO NOT MODIFY BEYOND THIS POINT
...
#error "Anedya Core SDK is currently under development and does not support dynamic memory allocation yet"
#endif

#ifdef ANEDYA_CONNECTION_METHOD_HTTP
#error "Anedya Core SDK is currently under development and does not support HTTPS connection yet"
#endif
