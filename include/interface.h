...
*/
    ...
    */
    anedya_err_t anedya_interface_mqtt_init(anedya_mqtt_client_handle_t *client);
    ...
    */
    anedya_err_t anedya_interface_mqtt_disconnect(anedya_mqtt_client_handle_t *client);
    ...
    */
    size_t anedya_interface_mqtt_status(anedya_mqtt_client_handle_t *client);
    ...
    */
    anedya_err_t anedya_interface_mqtt_subscribe(anedya_mqtt_client_handle_t *client,char *topic, int topilc_len, int qos);

    anedya_err_t anedya_interface_mqtt_unsubscribe(anedya_mqtt_client_handle_t *client,char *topic, int topic_len);

    anedya_err_t anedya_interface_mqtt_publish(anedya_mqtt_client_handle_t *client,char *topic, int topic_len, char *payload, int payload_len, int qos);
#endif
