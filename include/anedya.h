...
anedya_err_t anedya_initialize_config(anedya_config_t *config, anedya_device_id_t devId, char *connection_key, size_t connection_key_len);

anedya_err_t anedya_set_region(anedya_config_t *config, char *region);
